...
variable "VEGITO_DOCKER_DEBIAN_OBS_IMAGE_LATEST" {
  default = "${VEGITO_PUBLIC_REPOSITORY}/debian-obs:latest"
}

variable "VEGITO_DOCKER_DEBIAN_OBS_IMAGE_VERSION" {
  default = "${VEGITO_PUBLIC_REPOSITORY}/debian-obs:${VERSION}"
}
...
variable "VEGITO_DOCKER_DEBIAN_OBS_VSCODE_GOLANG_AI_DOCKER_DIR" {
  default = "${VEGITO_DOCKER_DEBIAN_DIR}/obs"
}

variable "VEGITO_DOCKER_DEBIAN_OBS_VSCODE_GOLANG_AI_DOCKER_IMAGE_REGISTRY_CACHE" {
  default = "${VEGITO_DOCKER_DEBIAN_IMAGE_REGISTRY_CACHE}-obs"
}

variable "VEGITO_DOCKER_DEBIAN_OBS_VSCODE_GOLANG_AI_DOCKER_IMAGE_LATEST" {
  default = "${VEGITO_PUBLIC_REPOSITORY}-debian-obs:latest"
}

variable "VEGITO_DOCKER_DEBIAN_OBS_VSCODE_GOLANG_AI_DOCKER_IMAGE_VERSION" {
  default = "${VEGITO_PUBLIC_REPOSITORY}-debian-obs:${VERSION}"
}

variable "VEGITO_DOCKER_DEBIAN_OBS_VSCODE_GOLANG_AI_DOCKER_IMAGE_DOCKER_BUILDX_LOCAL_CACHE" {
  default = "${VEGITO_DOCKER_DEBIAN_IMAGE_DOCKER_BUILDX_LOCAL_CACHE}-obs"
}

variable "VEGITO_DOCKER_DEBIAN_OBS_VSCODE_GOLANG_AI_DOCKER_IMAGE_DOCKER_BUILDX_LOCAL_CACHE_WRITE" {
  default = "type=local,mode=max,dest=${VEGITO_DOCKER_DEBIAN_OBS_VSCODE_GOLANG_AI_DOCKER_IMAGE_DOCKER_BUILDX_LOCAL_CACHE}"
}

variable "VEGITO_DOCKER_DEBIAN_OBS_VSCODE_GOLANG_AI_DOCKER_IMAGE_DOCKER_BUILDX_LOCAL_CACHE_READ" {
  default = "type=local,src=${VEGITO_DOCKER_DEBIAN_OBS_IMAGE_DOCKER_BUILDX_LOCAL_CACHE}"
}


group "vegito-debian-obs-vscode-golang-ai-docker" {
  targets = [

...
# If VEGITO_FLUTTER_DEBIAN_CONTAINER_INSTALL is set to "true", run the debian-flutter-container-install.sh script
...
# Example: export VEGITO_FLUTTER_DEBIAN_CONTAINER_INSTALL=true
if [ "${VEGITO_FLUTTER_DEBIAN_CONTAINER_INSTALL:-}" = true ]; then
    debian-flutter-container-install.sh
fi
